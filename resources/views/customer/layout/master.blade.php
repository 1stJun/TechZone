            ...
            <div class="grid wide">
                <div class="row sm-gutter app__content">
                            ...
                            <ul class="category-list">
                                @foreach ($categories as $category)
                                    <li class="category-item">
                                        <a href="{{ url('customer/category/' . $category->catID) }}"
                                            class="category-item__link {{ request()->is('customer/category/' . $category->catID) ? 'active' : '' }}">
                    ...
                    <div class="col l-9 m-12 c-12">
                        <div id="filter" class="home-filter hide-on-mobile-tablet">
                            <span class="home-filter__label">Sort by</span>
                            <a href="{{ url('customer/index') }}" class="home-filter__btn btn active">
                                Popular
                            </a>
                            <a href="{{ url('customer/index') }}" class="home-filter__btn btn">
                                Latest
                            </a>
                            <a href="{{ url('customer/index') }}" class="home-filter__btn btn">
                                Top Sales
                            ...
                            <div class="select-input">
                                ...
                                <ul class="select-input__list">
                                    <li class="select-input__item">
                                        <a href="{{ url('customer/index') }}" class="select-input__link">Price: Low
                                            to high</a>
                                    </li>
                                    <li class="select-input__item">
                                        <a href="{{ url('customer/index') }}" class="select-input__link">Price: High
                                            to low</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            {{-- <div class="home-filter__page">
                                ...
                                <div class="home-filter__page-control">
                                    <a href="" class="home-filter__page-btn home-filter__page-btn--disabled">
                                        <i class="home-filter__page-icon fa-solid fa-angle-down fa-rotate-90"></i>
                                    </a>
                                    <a href="" class="home-filter__page-btn">
                                        <i class="home-filter__page-icon fa-solid fa-angle-down fa-rotate-270"></i>
                                    </a>
                                </div>
                            </div> --}}
                        </div>
